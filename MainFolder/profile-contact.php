<?php 
    ...
    $emegencyNumber = $studentData["emergency_number"];
    $emegencyEmail = $studentData["emergency_email"];
              ...
              <div class="card-body">
                <div class="row">
                  <div class="mb-3 col-md-6">
                    ...
                    <input class="form-control text-dark" type="text" id="MotherEmail" name="MotherEmail" value="<?php echo $motherEmail; ?>"
                      autofocus disabled />
                  </div>
                  <div class="mb-3 col-md-6">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input disabled type="text" id="phoneNumber" name="phoneNumber" class="form-control text-dark"
                        value="<?php echo $motherNumber; ?>" />
                    </div>
                  </div>
                  <div class="mb-3 col-md-6">
                    <label for="FatherEmail" class="form-label">Father Email</label>
                    <input disabled class="form-control text-dark" type="text" id="FatherEmail" name="FatherEmail"
                  ...
                  <div class="mb-3 col-md-6">
                    ...
                    <input disabled type="text" class="form-control text-dark" id="address" name="address"
