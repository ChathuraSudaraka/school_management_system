        ...
        <div class="sidebar pe-4 pb-3 nscroll">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="attendance.php" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Attendance</a>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                             <!--    <tr>
                                   <td>1</td>
                                    <td>2022-01-01</td>
                                    <td><p class="aStatus">Present</p></td>
                                </tr>  -->


                                <?php 

                                $report = $conn->query("SELECT * FROM student_attendance WHERE student_index_number = '23056' ORDER BY `date` desc");

                                if($report->num_rows == 0) {
                                    echo '<tr>
                                    <td colspan="3" style="background: orange; color: red;">No Data Available</td>
                                </tr>';
                                }
                                else {
                                    for ($i=1; $i <= $report->num_rows; $i++) { 
                                        $attendance = $report->fetch_assoc();

                                        if($attendance["status"] == "false") {
                                            echo '<tr>
                                   <td>'. $i .'</td>
                                    <td>'. $attendance["date"] .'</td>
                                    <td><p class="aStatus b">Absent</p></td>
                                </tr>';
                                        }
                                        else {
                                            echo '<tr>
